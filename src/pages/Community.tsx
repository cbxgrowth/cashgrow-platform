...
import { Users, MessageCircle, Calendar, Trophy, Star, TrendingUp, Heart, Share2, ExternalLink, Github, Twitter, Linkedin, Youtube, BookOpen, Zap, Target, Award } from "lucide-react";
const Community = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-secondary/5 to-background">
      {/* Hero Section */}
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {topContributors.map((contributor, index) => <Card key={index} className="text-center hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  ...
                  <Badge className={contributor.level === 'Expert' ? 'bg-yellow-100 text-yellow-700' : contributor.level === 'Advanced' ? 'bg-blue-100 text-blue-700' : 'bg-green-100 text-green-700'}>
                    {contributor.level}
                  </Badge>
                </CardHeader>
                <CardContent>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-4">
            {recentDiscussions.map((discussion, index) => <Card key={index} className="hover:shadow-md transition-all duration-300 cursor-pointer">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {upcomingEvents.map((event, index) => <Card key={index} className="hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <div className="flex items-center justify-between mb-2">
                    <Badge className={event.type === 'Online' ? 'bg-green-100 text-green-700' : event.type === 'Presencial' ? 'bg-blue-100 text-blue-700' : 'bg-purple-100 text-purple-700'}>
                      {event.type}
                    </Badge>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {socialChannels.map((channel, index) => <Card key={index} className="text-center hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CardHeader>
