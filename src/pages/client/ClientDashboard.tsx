...
const ClientDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 lg:space-y-8 max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
      ...
      <div className="flex flex-col space-y-3 sm:space-y-4 dashboard-header opacity-0 translate-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          <Button variant="outline" size="sm" className="hover-scale touch-target">
            <Calendar className="mr-2 h-4 w-4" /> 
            Últimos 30 dias
          </Button>
          <Button size="sm" className="hover-scale bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 touch-target">
      ...
      <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-3 dashboard-card opacity-0 translate-y-4">
        <Card className="mobile-card hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer group border-l-4 border-l-green-500">
        ...
        <Card className="mobile-card hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer group border-l-4 border-l-purple-500">
          <CardHeader className="pb-3 p-4 sm:p-6">
            <div className="flex items-center gap-3">
        ...
        <Card className="mobile-card hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer group border-l-4 border-l-orange-500 sm:col-span-1 col-span-1">
          <CardHeader className="pb-3 p-4 sm:p-6">
            <div className="flex items-center gap-3">
      ...
      <div className="grid gap-4 sm:gap-6 lg:gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-4 sm:space-y-6 lg:space-y-8">
          ...
          <Card className="dashboard-card opacity-0 translate-y-4 bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200 mobile-card">
