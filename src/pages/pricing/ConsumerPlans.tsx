              ...
              <table className="w-full">
                ...
                <tbody>
                  {[
                    ...
                    { feature: 'Transações/mês', free: '5', premium: 'Ilimitadas', vip: 'Ilimitadas' },
                    { feature: 'Suporte', free: 'Email', premium: 'Prioritário', vip: 'Dedicado 24/7' },
                    { feature: 'Retirada', free: 'R$ 50 mín.', premium: 'Instantânea', vip: 'Instantânea' },
                    { feature: 'Clube VIP', free: '✗', premium: 'Básico', vip: 'Completo' },
                    { feature: 'Missões', free: 'Básicas', premium: 'Avançadas', vip: 'Exclusivas' }
                  ].map((row, idx) => (
